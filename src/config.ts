export const config = {
    ...
    projects: [
        {
            ...
            description: "'s first intelligent advanced AI chatbot powered by a custom Large Language Model. Features natural language understanding, contextual conversations, and multilingual support including Bengali."
        },
        {
            id: 2,
            title: "VoteChain",
        ...
        },
        {
            ...
            description: "A flood prediction model specifically designed for kanpur's river systems. Analyzes weather patterns, water levels, and historical data to provide accurate flood forecasts and alerts."
        },
        {
            id: 7,
            title: "Phoenix",
    ...
    contact: {
        ...
        linkedin: "https://linkedin.com/in/yashavshukla/",
        twitter: "#",
        facebook: "#",
        instagram: "https://instagram.com/yashavshukla?igsh=MnRjd2FieTNkeDls"
    },
    skills: {
        develop: {
            title: "AI DEVELOPER",
