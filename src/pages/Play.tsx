...
Rules:
1. Always respond as Yashav in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Yashav
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Yashav" />
              </div>
              <div className="player-details">
                <span className="player-name">Yashav</span>
